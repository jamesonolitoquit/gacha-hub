...
export const bd2Taxonomies: GameTaxonomyConfig = {
  classes: [
    { slug: 'warrior',    label: 'Warrior',    color: '#e74c3c', icon: 'sword',   sortOrder: 0 },
    { slug: 'defender',   label: 'Defender',   color: '#3498db', icon: 'shield',  sortOrder: 1 },
    { slug: 'magician',   label: 'Magician',   color: '#9b59b6', icon: 'staff',   sortOrder: 2 },
    { slug: 'supporter',  label: 'Supporter',  color: '#2ecc71', icon: 'heart',   sortOrder: 3 },
  ],

  rarities: [
    { slug: 'five-star',  label: '5★', stars: 5, color: '#ffd700',  sortOrder: 2 },
    { slug: 'four-star',  label: '4★', stars: 4, color: '#9b59b6',  sortOrder: 1 },
    { slug: 'three-star', label: '3★', stars: 3, color: '#3498db',  sortOrder: 0 },
  ],
  ...
  stats: [
    ...
    { slug: 'agi',       label: 'AGI',      suffix: '',      format: 'integer',    group: 'secondary' },
  ],
  ...
  skillTypes: [
    ...
    { slug: 'normal-attack', label: 'Normal' },
...
export const bd2Nav: NavItem[] = [
  ...
  { slug: 'builds', label: 'Builds', page: 'index' },
  { slug: 'teams', label: 'Teams', page: 'index' },
  {
